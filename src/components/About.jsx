		...
		<div className="min-h-screen bg-[#f7f6f5]">
			...
			<section className="px-4 sm:px-8 md:px-24 pt-12 sm:pt-16 pb-2">
				...
				<h2 ref={headlineRef}
					...
					As a technology entrepreneur and business leader, I help organizations drive growth through innovative digital solutions, hospitality technology, and strategic business development.
					...
					<div className="md:col-span-2 flex flex-col gap-4 h-full">
						...
						<div ref={textCardRef}
							...
							<p className="text-sm sm:text-base md:text-lg text-stone-900 leading-relaxed mb-4">
								With experience in hospitality technology, digital transformation, and business
