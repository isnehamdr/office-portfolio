  ...
  return (
    ...
    >
      <Link
        ...
        className="block bg-white max-w-xl mx-auto rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 flex flex-row cursor-pointer group h-full"
      >
        <div className="w-28 sm:w-40 md:w-44 h-40 sm:h-52 flex-shrink-0 overflow-hidden">
          <img
            src={article.image}
...
export default function Blogs() {
  ...
  const smallArticles = blogs.slice(1, 4); 
  ...
  return (
    ...
    >
      ...
      <h2
        ref={headingRef}
        className="text-2xl sm:text-3xl lg:text-4xl font-normal text-gray-900 mb-7 sm:mb-8"
        style={revealStyle(headingVisible, { direction: "up", distance: 28, delay: 0.1, duration: 1.05 })}
      >
        Latest Articles
      </h2>
      ...
      <div
        ref={featuredRef}
        className="mb-6 sm:mb-8"
        style={revealStyle(featuredVisible, { direction: "up", distance: 50, delay: 0.15, duration: 1.2 })}
      >
        <Link
          to={`/blog-detail/${featuredArticle.slug}`}
          className="block bg-white rounded-2xl overflow-hidden flex flex-col sm:flex-row group cursor-pointer shadow-sm hover:shadow-md transition-shadow duration-300"
        >
          <div className="w-full sm:w-[45%] lg:w-[480px] xl:w-[540px] flex-shrink-0 overflow-hidden h-56 sm:h-auto">
            <img
              src={featuredArticle.image}
          ...
          <div className="flex flex-col justify-center p-6 sm:p-8 lg:p-10 flex-1">
            <p className="text-gray-400 text-xs sm:text-sm mb-3">{featuredArticle.date}</p>
            <h3 className="text-gray-900 text-xl sm:text-2xl lg:text-3xl font-normal leading-snug mb-4">
              {featuredArticle.title}
            </h3>
            <p className="text-gray-500 text-sm sm:text-base leading-relaxed mb-8 sm:mb-10">
            ...
            <span className="inline-flex items-center gap-2 text-sm font-medium text-gray-900 border-b border-gray-900 pb-0.5 w-fit hover:opacity-60 transition-opacity">
              Read Article
