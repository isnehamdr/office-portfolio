...
export default function SelectedProjects() {
  return (
    <div className="min-h-screen bg-[#f7f6f5] font-sans">
      {/* Nav */}
      <nav className="px-4 sm:px-12 md:px-24 pt-6 sm:pt-8 pb-4 flex items-center gap-2">
        <div className="flex items-center gap-1.5">
          <span className="text-sm sm:text-base font-semibold tracking-[0.10em] uppercase text-gray-800">
            Creative Works
          </span>
        </div>
      </nav>
      ...
      <main className="px-4 sm:px-12 md:px-24 pb-16">
        <h2 className="text-2xl sm:text-4xl font-normal text-gray-900 mt-2 mb-6 sm:mb-8">
          Selected Projects
        </h2>
