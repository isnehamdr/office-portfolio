...
export default function FeaturedClients() {
  ...
  const [mobileRef, mobileVisible] = useReveal();
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-10 lg:px-16">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-[380px] flex-shrink-0 flex flex-col justify-center">
            ...
            >
              We work closely with our clients to create solutions that are
              innovative, scalable, and built for long-term success.
            </p>
          ...
          {/* DESKTOP GRID */}
          <div className="hidden sm:block flex-1 border-l border-gray-300">
            {rows.map((row, rowIndex) => (
              <div key={rowIndex} className="grid grid-cols-4">
                {row.map((client, colIndex) => (
                  <ClientLogo
