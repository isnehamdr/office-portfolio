            ...
            <div className="mt-10 lg:mt-14">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-3">
                  <p className="text-sm font-medium text-gray-700">Pokhara Office</p>
                  <div className="rounded-2xl overflow-hidden shadow-sm border border-gray-200">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3515.5509677172836!2d83.96902867494164!3d28.22095210265291!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39959550342ad0e7%3A0x814ba2a53a77c346!2sSandip%20Bhattarai!5e0!3m2!1sen!2snp!4v1789460202432!5m2!1sen!2snp"
                      width="100%"
                      height="350"
                      style={{ border: 0 }}
                      allowFullScreen=""
                ...
                {/* Kathmandu Map */}
                <div className="flex flex-col gap-3">
                  <p className="text-sm font-medium text-gray-700">Kathmandu Office</p>
                  <div className="rounded-2xl overflow-hidden shadow-sm border border-gray-200">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3533.9784341871978!2d85.36321487492124!3d27.65613892774907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb199e66aa5e89%3A0x686ea64571f6176c!2sSandip%20Bhattarai!5e0!3m2!1sen!2snp!4v1789460260007!5m2!1sen!2snp"
                      width="100%"
                      height="350"
                      style={{ border: 0 }}
                      allowFullScreen=""
                      loading="lazy"
                      referrerPolicy="strict-origin-when-cross-origin"
                      title="Kathmandu Office Location"
                    ></iframe>
                  </div>
                </div>
              </div>
